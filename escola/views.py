...
class ListaMatriculaEstudante(generics.ListAPIView):
    ...
    def get_queryset(self):
        queryset = Matricula.objects.filter(estudante_id=self.kwargs.get('pk')).order_by('id')
        return queryset
...
class ListaMatriculaCurso(generics.ListAPIView):
    ...
    """
    def get_queryset(self):
        queryset = Matricula.objects.filter(curso_id=self.kwargs.get('pk')).order_by('id')
        return queryset
